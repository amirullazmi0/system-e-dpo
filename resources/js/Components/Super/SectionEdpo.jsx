...
const SectionEdpo = ({ notif, edpo }) => {
    ...
    const handleEdit = (e) => {
        ...
        router.get('/super/edit-edpo/' + e, data)
    }
    ...
    const handleDetail = (id, nama) => {
        ...
        router.get('/super/edpo/detail/' + id, data)
    }
    ...
    const handleTertangkap = (id) => {
        ...
        router.post('/super/add-tertangkap/' + id, data)
    }
